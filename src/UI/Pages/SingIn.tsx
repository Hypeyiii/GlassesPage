...
const SingIn = () => {
  ...
  return (
    <div
      className="mt-24 md:mt-32 grid justify-center relative items-center w-[50%] h-[500px] m-auto border-black/20 text-center text-wrap bg-gray-300 dark:bg-white
    border p-10"
    >
      <header className="absolute top-0 left-o right-0 w-full py-10">
        <nav>
