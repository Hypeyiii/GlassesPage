...
const SingIn = () => {
  ...
  return (
    <div
      className="mt-24 md:mt-32 grid justify-center relative items-center w-[80%] md:w-[50%] h-[600px] m-auto text-center text-wrap text-black dark:text-white p-10"
    >
      <header className="absolute top-0 left-o right-0 w-full py-5 md:py-10">
        <nav>
          <ul className="gap-x-2 grid grid-cols-2 w-[90%] mx-auto mb-5 border-b-[1px] py-2 px-4 border-black dark:border-white text-black dark:text-white text-xl uppercase">
            <li
              id="title"
              className={`${
                wantToSingIn ? "opacity-100" : "opacity-50"
              } w-full h-full border-r border-black dark:border-white cursor-pointer`}
