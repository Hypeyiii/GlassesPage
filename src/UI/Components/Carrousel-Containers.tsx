...
export function ModernGlasses() {
  return (
    <div className="w-full flex flex-col gap-4 justify-center items-center relative [&>div>img]:hover:scale-105 bg-white/60 rounded-lg">
      ...
      <div className="md:absolute md:right-10 top-0 bottom-0 h-full md:w-[400px] text-white dark:text-black text-center m-auto flex flex-col gap-2 md:gap-4 justify-center items-center">
